...
begin
  uut: entity work.reset_expander(rtl)
    ...
    begin
      ...
      assert uut_rst_pipe_25MHz = "0" report "rst pipe 25MHz is clear";
      assert uut_rst_pipe_50MHz = "000" report "rst pipe 50MHz is clear";
      ...
      assert uut_rst_pipe_25MHz = "0" report "rst pipe 25MHz is clear";
      assert uut_rst_pipe_50MHz = "001" report "rst pipe 50MHz clocked in 1";

      wait for c_HALF_PERIOD_50_MHz; -- t=165 ns
      assert clocks = "11" report "both clocks have just had a rising edge";
      assert uut_rst_pipe_25MHz = "1" report "rst pipe 25MHz clocked in 1";
      assert uut_rst_pipe_50MHz = "011" report "rst pipe 50MHz clocked in 2";

      wait for c_HALF_PERIOD_50_MHz; -- t=175 ns
      assert clocks = "10" report "50 MHz falling edge";
      assert uut_rst_pipe_25MHz = "1" report "rst pipe 25MHz unchanged";
      assert uut_rst_pipe_50MHz = "011" report "rst pipe 50MHz unchanged";

      wait for c_HALF_PERIOD_50_MHz; -- t=185 ns
      assert clocks = "01" report "25 MHz falling edge, 50 MHz rising edge";
      assert uut_rst_pipe_25MHz = "1" report "rst pipe 25MHz clocked in 1";
      assert uut_rst_pipe_50MHz = "111" report "rst pipe 50MHz clocked in 3";

      wait for c_HALF_PERIOD_50_MHz; -- t=195 ns
      assert clocks = "00" report "50 MHz falling edge";
      assert uut_rst_pipe_25MHz = "1" report "rst pipe 25MHz unchanged";
      assert uut_rst_pipe_50MHz = "111" report "rst pipe 50MHz unchanged";
      assert reset_out = "00" report "Reset out should not be asserted yet";

      wait for c_HALF_PERIOD_50_MHz; -- t=205 ns
      assert clocks = "11" report "both clocks have just had a rising edge";
      assert uut_rst_pipe_25MHz = "1" report "rst pipe 25MHz clocked in 2";
      assert uut_rst_pipe_50MHz = "111" report "rst pipe 50MHz clocked in 4";
      ...
      assert clocks = "01" report "25 MHz falling edge, 50 MHz rising edge";
      assert uut_rst_pipe_25MHz = "1" report "rst pipe 25MHz unchanged";
      assert uut_rst_pipe_50MHz = "110" report "rst pipe 50MHz clocked out 1";
      ...
      assert uut_rst_pipe_25MHz = "0" report "rst pipe 25MHz clocked out 1";
      assert uut_rst_pipe_50MHz = "100" report "rst pipe 50MHz clocked out 2";

      wait for c_HALF_PERIOD_50_MHz; -- t=1455 ns
      assert clocks = "10" report "50 MHz falling edge";
      wait for c_HALF_PERIOD_50_MHz; -- t=1465 ns
      assert clocks = "01" report "25 MHz falling edge, 50 MHz rising edge";
      assert uut_rst_pipe_25MHz = "0" report "rst pipe 25MHz unchanged";
      assert uut_rst_pipe_50MHz = "000" report "rst pipe 50MHz clocked out 3";
      assert reset_out = "11" report "Reset out should still be asserted";
      ...
      assert clocks = "11" report "25 MHz rising edge, 50 MHz rising edge";
      assert uut_rst_pipe_25MHz = "0" report "rst pipe 25MHz clocked out 2";
      assert uut_rst_pipe_50MHz = "000" report "rst pipe 50MHz clocked out 4";
