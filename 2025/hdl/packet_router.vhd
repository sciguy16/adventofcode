...
begin
	...
	port map (
        ...
        axi_str_rxd_tvalid_IN => DOWNSTREAM_RXD_TVALID(C_DESTINATION_TOP),
        axi_str_rxd_tready_OUT => DOWNSTREAM_RXD_TREADY(C_DESTINATION_TOP),
        axi_str_rxd_tdata_IN => DOWNSTREAM_RXD_TDATA(C_DESTINATION_TOP),
