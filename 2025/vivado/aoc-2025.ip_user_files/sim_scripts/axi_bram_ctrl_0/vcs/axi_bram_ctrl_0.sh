...
#
# Script generated by Vivado on Sun Dec 28 08:18:27 GMT 2025
...
#                axi_bram_ctrl_0.sh [-rerun]
#                axi_bram_ctrl_0.sh [-reset_run]
#                axi_bram_ctrl_0.sh [-clean]
...
# script info
echo -e "axi_bram_ctrl_0.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../opt/xilinx/2025.2/data/rsb/busdef" \
...
Usage: axi_bram_ctrl_0.sh [-rerun]\n\
Usage: axi_bram_ctrl_0.sh [-reset_run]\n\
Usage: axi_bram_ctrl_0.sh [-clean]\n\
