...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../aoc-2025.srcs/sources_1/ip/axis_dwidth_converter_8_32/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_dwidth_converter_8_32 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_dwidth_converter_8_32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_dwidth_converter_8_32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
