...
#
# Script generated by Vivado on Sat Dec 27 21:31:01 GMT 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_0 xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:bram_wrapper:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -log simulate.log
}
