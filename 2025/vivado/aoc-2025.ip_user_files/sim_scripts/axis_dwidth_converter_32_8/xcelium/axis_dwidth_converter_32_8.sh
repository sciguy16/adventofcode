...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../aoc-2025.srcs/sources_1/ip/axis_dwidth_converter_32_8/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_dwidth_converter_32_8 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_dwidth_converter_32_8 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/david/gits/adventofcode/2025/vivado/aoc-2025.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_dwidth_converter_32_8_sc.so .tmp_log xcelium_lib waves.shm c.obj)
