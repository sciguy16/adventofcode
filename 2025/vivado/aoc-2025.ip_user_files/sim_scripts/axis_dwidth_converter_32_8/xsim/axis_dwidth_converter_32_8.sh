...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_dwidth_converter_32_8 xil_defaultlib.axis_dwidth_converter_32_8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_dwidth_converter_32_8 -key {Behavioral:sim_1:Functional:axis_dwidth_converter_32_8} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_dwidth_converter_32_8.wdb xsim.dir libdpi.so)
