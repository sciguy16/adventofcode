...
#
# Script generated by Vivado on Sat Dec 06 20:28:47 GMT 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_dwidth_converter_32_8.sh
...
#
# Usage        : axis_dwidth_converter_32_8.sh
#                axis_dwidth_converter_32_8.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_dwidth_converter_32_8.sh [-reset_run]
#                axis_dwidth_converter_32_8.sh [-reset_log]
#                axis_dwidth_converter_32_8.sh [-help]
#
...
#                script (type 'axis_dwidth_converter_32_8.sh -help' for more information).
#
...
# script info
echo -e "axis_dwidth_converter_32_8.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_dwidth_converter_32_8.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../aoc-2025.srcs/sources_1/ip/axis_dwidth_converter_32_8/hdl" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_dwidth_converter_32_8 xil_defaultlib.glbl -o axis_dwidth_converter_32_8_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_dwidth_converter_32_8_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_dwidth_converter_32_8_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_dwidth_converter_32_8_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_dwidth_converter_32_8.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_dwidth_converter_32_8.sh [-help]\n\
Usage: axis_dwidth_converter_32_8.sh [-step]\n\
Usage: axis_dwidth_converter_32_8.sh [-lib_map_path]\n\
Usage: axis_dwidth_converter_32_8.sh [-reset_run]\n\
Usage: axis_dwidth_converter_32_8.sh [-reset_log]\n\
Usage: axis_dwidth_converter_32_8.sh [-keep_index]\n\
Usage: axis_dwidth_converter_32_8.sh [-noclean_files]\n\n\
